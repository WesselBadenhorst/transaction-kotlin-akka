...
fun main() {
    ...
    val actorRef2 = actorSystem.actorOf(
        Props.create(HelloActor::class.java).withDispatcher("actor2-dispatcher"),
        "actor2"
    )
    actorSystem.log().info("Sending 'Tom' and Mary")
    actorRef1.tell("Tom", ActorRef.noSender())
    actorRef2.tell("Mary", ActorRef.noSender())
    Thread.sleep(1000)
